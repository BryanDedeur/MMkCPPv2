...
typedef struct Options : Base {
    // in files
	string infile;
    string graphfile = "../problem-instances/benchmarks/egl-large/egl-g1-A.dat"; // directory must be relative to the executable
    ...
    string seedsFile = "../seed-files/10seeds.txt";
    long int* seeds;
